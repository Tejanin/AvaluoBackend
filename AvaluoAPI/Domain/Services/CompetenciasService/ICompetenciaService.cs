...
namespace AvaluoAPI.Domain.Services.CompetenciasService
{
    public interface ICompetenciaService
    {
        ...
        Task<IEnumerable<AsignaturaConCompetenciasConEstadosViewModel>> GetMapaCompetencias(int idCarrera, int idTipoCompetencia); // Obtiene el mapa de competencias de una carrera.
